...
func (b *Build) completionContainer(images BuildPodImages, buildContext BuildContext, args []string, env []corev1.EnvVar, volumeMounts []corev1.VolumeMount) corev1.Container {
	if b.Spec.NeedRegistryCache() {
		env = append(env, corev1.EnvVar{Name: CacheTagEnvVar, Value: b.Spec.Cache.Registry.Tag})
	}
